...
# #### reward system v2 --- add the rigid body positional reward #####
# export w_finger_pos_rew=True
# export hand_qpos_rew_coef=0.01
# export tracking_save_info_fn='/cephfs/xueyi/data/GRAB_Tracking_PK_wrbpos/data'
# export tracking_data_sv_root='/cephfs/xueyi/data/GRAB_Tracking_PK_wrbpos/data'
# #### reward system v2 --- add the rigid body positional reward #####
...
# bash scripts/run_tracking_headless_grab_single_ctlv2.sh 0 'ori_grab_s2_duck_inspect_1'
