...
export latent_obs_encoder_decoder_weights_fn=''
# export use_obs_latent_in_obs=True
export use_obs_latent_in_obs=False
export diff_latents=False
export teacher_use_force_obs=False
export use_latent_obs=False
export obs_latent_dim=32 # 256
export teacher_model_w_vel_obs=False
